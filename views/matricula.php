                ...
                if (isset($_POST["anio"])) {
                    ...
                    <form method="post" enctype="multipart/form-data" class="niceform" action="index.php?controlador=Matricula&accion=verificar">
                        <table style="margin: 0 auto; width: 590px">
                            ...
                            <tr>
                                <td>
                                    <select id="tipo_documento" name="tipo_documento" class="validar">
                                        <option value="">::Seleccionar::</option>
                                        <?php
                                        foreach ($tipoDocumento as $valor) {
                                            ?>
                                ...
                                <td><input type="text" value="" name="numero_documento" size="25" id="nombre" class="validar" /></td>
                            </tr>                        
                            <tr>
