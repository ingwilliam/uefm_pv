...
class AreaController extends ControllerBase {
    ...
    private $url = "area.php";
    private $modelo = "models/AreaModel.php";
    private $table = "area";
    private $id = "id";
    private $pagina = "area";
    ...
    public function area() {
        ...
        //traemos todos los datos del area logueado
        ...
        //determina que consulta fue la que realizo en area en la busqueda
        ...
        if ($_GET) {
            ...
            $arrayRegistro = $Area->estructuraArea();
        }
        ...
        $paginador->param = "&controlador=Area&accion=area".$parametros_busqueda;
    ...
    public function nuevoRegistro() {
        ...
        //Creamos el array para el formulario del area
        $arrayRegistro = $_POST;
        ...
        if (in_array("1", $arrayPermiso) == true || in_array("2", $arrayPermiso) == true) {
            ...
            $id = $Area->newArea($_POST);
            $arrayRegistro = $Area->consultArea($id);
            $vars['alerta'] = 1;
            $vars['accion'] = "editar";
        } else {
            $vars['error'] = "No tienen permisos para ingresar ingresar información, Comunicarse con el administrador del sistema";
    ...
    public function editarRegistro() {
        ...
        if ($Area->confirmArea($id)) {            
            ...
            $formXhtml->location("index.php?controlador=Area&accion=area");
        }
