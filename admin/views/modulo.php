                                ...
                                <form class="form-validar form-horizontal" action="index.php?controlador=<?php echo $controlador; ?>&accion=<?php echo $vars["accion"]; ?>Registro" method="post" class="formvalidar" enctype="multipart/form-data">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                                <label class="col-sm-2 control-label" for="padre">Modulo Padre</label>
                                                <div class="col-sm-10">
                                                    <?php $vars["formXhtml"]->select("padre", "padre", $vars["arrayRegistro"]["padre"], "form-control", "Padre", "", "modulo", "id", "nombre", "", "1", " nombre ASC"); ?>
                                                </div>
                                            </div>
                                        <div class="form-group">
