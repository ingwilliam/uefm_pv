                                    ...
                                    <form class="form-validar form-horizontal" action="index.php?controlador=<?php echo $controlador; ?>&accion=<?php echo $vars["accion"]; ?>Registro" method="post" class="formvalidar" enctype="multipart/form-data">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <?php $vars["formXhtml"]->inputtext("text", "orden", "orden", $vars["arrayRegistro"]["orden"], "validar form-control", "Orden"); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="estado">Tipo:</label>
                                                <div class="col-sm-10">
                                                    <?php $vars["formXhtml"]->radio("tipo", "tipo", $vars["arrayRegistro"]["tipo"], "", "Tipo", "", array("PREESCOLAR" => "PREESCOLAR", "PRIMARIA" => "PRIMARIA", "BACHILLERATO" => "BACHILLERATO DE 6 A 9", "MEDIA" => "MEDIA VOCACIONAL DE 10 A 11")); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
