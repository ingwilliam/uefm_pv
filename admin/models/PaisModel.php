...
class PaisModel extends ModelBase {
     ...
     */
    public function listPais( $busqueda = "WHERE 1" , $order = "false" ) {
     ...
     * @return bool 
     */
    public function confirmPais( $id ) {
        settype($id, "integer");
        //realizamos la consulta de todos los usuarios
    ...
    public function modPais( $array ) {
        ...
        if( $this->confirmPais($array[$this->idTable]) )        
        {
     ...
     */
    public function consultPais( $id ) {
        //realizamos la consulta de todos los usuarios
        $consulta = $this->db->prepare('SELECT * FROM '.$this->table.' WHERE '.$this->idTable.' = "'.$id.'"');                 
        $consulta->execute();
    ...
    public function consultPaisWhere( $where ) {
        //realizamos la consulta de todos los usuarios        
     ...
     * @param $id int 
     */
    public function estructuraPais() {
