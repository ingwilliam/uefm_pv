...
class DepartamentoModel extends ModelBase {
     ...
     */
    public function listDepartamento( $busqueda = "WHERE 1" , $order = "false" ) {
     ...
     * @return bool 
     */
    public function confirmDepartamento( $id ) {
        settype($id, "integer");
        //realizamos la consulta de todos los usuarios
     ...
     * @return $id int
     */
    public function newDepartamento( $array ) {
     ...
     * @return $id int
     */
    public function modDepartamento( $array ) {
        ...
        if( $this->confirmDepartamento($array[$this->idTable]) )        
        {
     ...
     */
    public function consultDepartamento( $id ) {
        //realizamos la consulta de todos los usuarios
        $consulta = $this->db->prepare('SELECT * FROM '.$this->table.' WHERE '.$this->idTable.' = "'.$id.'"');                 
        $consulta->execute();
    ...
    public function consultDepartamentoWhere( $where ) {
        //realizamos la consulta de todos los usuarios        
     ...
     * @param $id int 
     */
    public function estructuraDepartamento() {
