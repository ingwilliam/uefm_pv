...
class CiudadModel extends ModelBase {
     ...
     */
    public function listCiudad( $busqueda = "WHERE 1" , $order = "false" ) {
     ...
     * @return bool 
     */
    public function confirmCiudad( $id ) {
        settype($id, "integer");
        //realizamos la consulta de todos los usuarios
     ...
     * @return $id int
     */
    public function newCiudad( $array ) {
     ...
     * @return $id int
     */
    public function modCiudad( $array ) {
        ...
        if( $this->confirmCiudad($array[$this->idTable]) )        
        {
     ...
     */
    public function consultCiudad( $id ) {
        //realizamos la consulta de todos los usuarios
        $consulta = $this->db->prepare('SELECT * FROM '.$this->table.' WHERE '.$this->idTable.' = "'.$id.'"');                 
        $consulta->execute();
    ...
    public function consultCiudadWhere( $where ) {
        //realizamos la consulta de todos los usuarios        
     ...
     * @param $id int 
     */
    public function estructuraCiudad() {
